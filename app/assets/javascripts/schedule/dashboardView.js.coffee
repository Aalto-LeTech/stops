...
if not O4.dashBoard.i18n
  throw "dashBoard i18n strings have not been loaded!"
...
@module 'O4', ->
  @module 'dashBoard', ->
    class @DashboardView
      ...
      constructor: (@planUrl) ->
        @i18n                      = O4.dashBoard.i18n     # accessible from the view like this: <span data-bind="text: $root.i18n['qwerty'] "></span>
